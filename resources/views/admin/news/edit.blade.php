                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select name="language" id="select-language" class="form-control select2">
                                        ...
                                        <option value="{{$lang->lang}}" {{ $lang->lang ===  $news->language? 'selected' : ''}}>{{$lang->name}}</option>
                                        @endforeach
                                    </select>
                                     @error('language')
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea name="meta_description" class="summernote-simple">{!!$news->meta_description!!}</textarea>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="is_breaking_news" class="custom-switch-input" value="1" {{ $news->is_breaking_news == 1 ? 'checked' : ''}}>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="show_at_slider" class="custom-switch-input" value="1" {{ $news->show_at_slider == 1 ? 'checked' : ''}}>
                                        <span class="custom-switch-indicator"></span>
                                    </label>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="show_at_popular" class="custom-switch-input" value="1" {{ $news->show_at_popular == 1 ? 'checked' : ''}}>
                                        <span class="custom-switch-indicator"></span>
                                    </label>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <label class="custom-switch mt-2">
                                        <input type="checkbox" name="status" class="custom-switch-input" value="1" {{ $news->status == 1 ? 'checked' : ''}}>
                                        <span class="custom-switch-indicator"></span>
                                    </label>
                                    @error('status')
                                        <p class="text-danger">{{ $message }}</p>
                                ...
                                <div class="form-group col-md-6 my-auto">
                                    <label class="">Tags</label>
                                        <input type="text" class="form-control inputtags" style="display: none;" name="tags" value="{{formateTags($news->tags()->pluck('name')->toArray())}}">
                                     @error('tags')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
